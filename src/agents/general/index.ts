...
JSON으로만 응답:
{
  ...
  "peerGroupAnalysis": "Peer Group 분석 (유사 국내 상장사 3~5개 선정, 각사 PER/EV-Multiple, 비상장 할인 30% 적용, 도출된 Valuation 범위, 300자)",
  "valuationOpinion": "기업가치 평가 의견 (현재 Valuation 적정성, Peer Group 대비 분석, 심사역 추정 기반 Multiple, 400자)",
  "exitStrategy": "Exit 전략 (IPO 일정/목표 시장, M&A 시나리오, 예상 Exit Multiple/IRR, 락업 해제 이후 회수 가정, 400자)",

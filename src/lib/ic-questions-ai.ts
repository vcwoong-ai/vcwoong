...
- question은 "답변에 따라 실제 투자 여부가 바뀌는 질문"이 되도록 구체적으로 다듬는다.
  나쁜 예: "향후 성장전략은 무엇인가?" (누구나 긍정적으로 답할 수 있어 투자판단에 영향 없음)
  좋은 예: "현재 매출이 소수 고객에 집중되어 있다면 신규 고객 확보의 실제 계약 전환율과
  반복매출 비중을 어떻게 입증할 수 있는가?" (관련 claim/근거 상태를 구체적으로 반영)
